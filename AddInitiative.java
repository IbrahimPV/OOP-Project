...
public class AddInitiative extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Initiate a New Event");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("Create a New Initiative");

        jLabel2.setText("Name of Initiative:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddInitiative.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
